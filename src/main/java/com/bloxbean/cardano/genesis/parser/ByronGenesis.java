...
public class ByronGenesis {
    ...
    public ByronGenesis(File byronGenesisFile) {
        try (FileInputStream fis = new FileInputStream(byronGenesisFile)) {
            ...
            throw new IllegalArgumentException("Byron genesis file not found at path : " + byronGenesisFile);
        }
    }
    ...
    private ObjectNode parseJson(InputStream is) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error parsing byron genesis file", e);
        }
        return jsonNode;
    }
